...
for images in os.listdir(path):
      ...
      try:
            ...
            if (images.endswith(".jpg")):
                  ...
                  gray = cv2.cvtColor(img, cv2.COLOR_BGR2RGB) #แปลงรูปภาพเป็นเฉพาะสีขาว-ดำ
                  ...
                  text_1 = pytesseract.image_to_string(img , lang='eng+tha_03', config='--psm 11')#ใช้Tesseract-OCR กับ Model ที่สร้างรวมเข้าด้วยกัน
                  text_2 = pytesseract.image_to_string(img , lang='tha_03', config='--psm 11')#ใช้Tesseract-OCR กับ Model ที่สร้างรวมเข้าด้วยกัน
